 ...
 */
import { createProjectSchema, updateProjectSchema, getProjectByIdSchema, listProjectsSchema, upsertProjectDomainModelSchema, removeProjectDomainModelSchema, } from './schemas/project.schemas.js';
...
export const projectTools = [
    {
        name: 'listProjects',
        description: 'List projects with optional filtering by status and pagination. ' +
    ...
    {
        name: 'getProjectById',
        description: 'Get a specific project by ID with complete details including metadata, ' +
    ...
    {
        name: 'createProject',
        description: 'Create a new software development project with metadata, tech stack, ' +
    ...
    },
    {
        ...
        description: 'Add or replace a domain model (class/interface/DTO) in a project\'s domain catalog. ' +
    ...
    },
    {
        ...
        description: 'Remove a domain model from a project\'s domain catalog by name. ' +
