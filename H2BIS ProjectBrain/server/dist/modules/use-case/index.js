 ...
 */
import { listUseCasesSchema, getUseCaseByIdSchema, createUseCaseSchema, updateUseCaseSchema, deleteUseCaseSchema, enhanceUseCaseSchema, updateUseCaseWithAISchema, getUseCaseWithProjectContextSchema, } from './schemas/useCase.schemas.js';
...
export const useCaseTools = [
    {
        name: 'listUseCases',
        description: 'List use cases with optional filtering by project and pagination. ' +
    ...
    {
        name: 'getUseCaseById',
        description: 'Get a specific use case by ID with complete details including functional requirements, ' +
    ...
    {
        name: 'createUseCase',
        description: 'Create a new use case with all necessary details. ' +
    ...
    {
        name: 'deleteUseCase',
        description: 'Delete a use case (soft delete). ' +
    ...
    {
        name: 'enhanceUseCase',
        description: 'Enhance a use case using AI. ' +
    ...
    },
    {
        ...
        description: 'Update a use case with AI-driven changes based on natural language instructions. ' +
    ...
    },
    {
        ...
        description: 'Retrieve a use case together with the full development context of its owning project ' +
